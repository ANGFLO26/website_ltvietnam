...
- D6 worker lifecycle: claim → commit durable `started` attempt → provider call ngoài DB transaction → commit result/status transaction; reaper phải hiểu `started/unknown`.

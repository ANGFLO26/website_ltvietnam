...
v0.4.1 remains `PROPOSED FOR FINAL VERIFICATION`. Promotion requires independent verification and user approval; no active implementation state is asserted.

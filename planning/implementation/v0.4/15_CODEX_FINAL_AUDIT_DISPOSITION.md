...
|---|---|---|---|---|---|
| FV-01 | High | **APPLIED** | Global unique D19; exact fingerprint v1; atomic transaction/conflict/read; races/timeouts/legacy policy/tests | `01` §C; `04` P7; `06`; `09` R-09; `10` | Search global scope/version/SHA-256; verify one Inquiry/Outbox and nine cases |
...
| FV-03 | High | **APPLIED** | Semantics A public-until-purge; 30-day configurable delay; 24h bounded cache; purge/orphan/restore | `01` §D; `04` P3/P11; `06`; `07`; `09` R-11; `10`; `12` | Search semantics/default/TTL; verify restore scans and purge lifecycle |
...
| FV-08 | Medium | **APPLIED** | Durable attempt table direction, ≥90d retention, duplicate rules, manual outcomes, no blind resend | `04` P7; `06`; `09` R-29; `10` | Check field list, five rules, four outcomes/report statuses |

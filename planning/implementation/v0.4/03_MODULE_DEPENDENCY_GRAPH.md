...
- D20: public media lifecycle phụ thuộc MediaUsageService, purge job, cache purge/expiry và consistency scanner.
...
| 2 | users | DB | P2 |
| 3 | media | DB, users, StoragePort, MediaUsageService | P3 |
| 4 | settings | DB | P2 |
...
| 18 | documents | media, SlugService, locale, controlled download | P3/P6A/B |
...
| 23 | inquiries | settings/email, products/services SET NULL, D19 repository | P7 |
